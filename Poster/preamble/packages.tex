...
% \usepackage{mathpazo} % Sets Palatino as the main text font and provides matching math fonts
% %\usepackage[osf]{libertinus} % Would set Libertinus as the main font, [osf] enables old-style figures (text-style numbers)
% 
% \usepackage{indentfirst} % Indents the first paragraph after section headings
% 
% \pagestyle{plain} % Simple page style: no headers, page number centered at the bottom
% 
...
% 
% \usepackage{geometry}
% % Would load geometry with default margin settings
