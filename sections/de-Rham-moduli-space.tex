...
M_{n, B}(\mc{X}) \cong \left\{ ((A_i, B_i)_{i = 1}^g, C) \in GL_n^{2g +1} \mymid \prod_{i=1}^{g}[A_i, B_i] = C, \, C^n = Id \right\} \modd GL_n.
\end{equation}
...
\begin{equation}
M_{\underline{m}, B}(\mc{X}) \cong \left\{ (A_i, B_i)_{i = 1}^g \in GL_n^{2g} \mymid \prod_{i=1}^{g}[A_i, B_i] = C_{\underline{m}} \right\} \modd GL_n,
\end{equation}
...
\begin{equation}
M_{n_{-d}, B}(\mc{X}) \cong \left\{ (A_i, B_i)_{i = 1}^g \in GL_n^{2g} \mymid \prod_{i=1}^{g}[A_i, B_i] = \mathrm{e}^{-\frac{2 \pi \mathrm{i}}{n} d} Id \right\} \modd GL_n.
\end{equation}
\end{prop}